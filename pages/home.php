<!-- Making a flexible grid (content) -->
<div class="row">
  ...
  <div class="right_side">
    <h2>Qui suis-je ?</h1>
      <div class="content">
        <img class="responsive" src="assets/img/presentation_me.jpg" alt="Portrait of me in Lisboa during a road-trip in 2017.">
        <div class="overlay">
          <div class="text">
            <h4>Hello World!</h4>
            <p>"More the knowledge lesser the ego, lesser the knowledge more the ego."</p>
